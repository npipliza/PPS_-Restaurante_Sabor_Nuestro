  ...
  createPieChart() {
    this.pie = new Chart(this.pieChart.nativeElement, {
      ...
      data: {
        ...
        datasets: [{
          label: 'Relación entre empleados.',
  ...
  createPieChartEmp() {
    this.pieEmp = new Chart(this.pieChartEmp.nativeElement, {
      ...
      data: {
        ...
        datasets: [{
          label: 'Órden del espacio de trabajo en los cambios de turno.',
      ...
      options: {
        plugins: {
          title: {
            display: true,
            text: 'Órden del espacio de trabajo en los cambios de turno.'
          }
        }
      }
    });
    ...
    this.barsEmp = new Chart(this.barChartEmp.nativeElement, {
      ...
      options: {
        ...
        plugins: {
          ...
          title: {
            display: true,
            text: '¿Están conformes los empleados con su espacio?'
          }
        }
      }
    });
    ...
    this.barsVerticalEmp = new Chart(this.barChartVerticalEmp.nativeElement, {
      ...
      options: {
        ...
        plugins: {
          ...
          title: {
            display: true,
            text: 'Indicador estado del espacio de trabajo en cambio de turno.'
          }
        }
      }
    });
  ...
  createDoughnutChartEmp() {
    this.donutEmp = new Chart(this.donutChartEmp.nativeElement, {
      ...
      data: {
        labels: ['Siempre', 'A veces', 'Pocas veces'],
        datasets: [{
          label: 'Realización de tareas del turno anterior.',
      ...
      options: {
        plugins: {
          title: {
            display: true,
            text: 'Realización de tareas del turno anterior'
          }
        }
      }
    });
